...
public class CryptoJUnitTest {
	...
	public void testEncryptCaesar() {
		...
		assertEquals("{lz{punGhuv{olyGz{ypun", CryptoManager.encryptCaesar("TESTING ANOTHER STRING", 999));
	...
	public void testDecryptCaesar() {
		...
		assertEquals("TESTING ANOTHER STRING", CryptoManager.decryptCaesar("{lz{punGhuv{olyGz{ypun", 999));
